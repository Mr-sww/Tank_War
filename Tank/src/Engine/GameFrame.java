...
public class GameFrame extends Frame implements ActionListener {
	...
	public Tank homeTank = new Tank(300, 560, true, Direction.STOP, this,50);// 实例化坦克
	...
	public GameFrame() {
		// 显示对战模式菜单
		GameModeMenu modeMenu = new GameModeMenu(this);
		modeMenu.setVisible(true);

		String gameMode = modeMenu.getSelectedMode();
		if (gameMode == null) {
		...
		String selectedLevel = levelMenu.getSelectedMode();
		if (selectedLevel == null) {
			System.exit(0); // 如果未选择难度级别，退出游戏
		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("NewGame")) {
			...
			homeTank = new Tank(300, 560, true, Direction.STOP,this,200);// 设置自己出现的位置
			...
			homeTank = new Tank(300, 560, true, Direction.STOP,this,20);// 设置自己出现的位置
